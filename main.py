...
app.config['SQLALCHEMY_DATABASE_URI'] = 'postgresql://postgres.vtzwgreehjufqdkxmbzr:healthyharbourwatchers@aws-0-ap-southeast-2.pooler.supabase.com:5432/postgres'
app.config['SECRET_KEY'] = "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6InZ0endncmVlaGp1ZnFka3htYnpyIiwicm9sZSI6InNlcnZpY2Vfcm9sZSIsImlhdCI6MTcxNTY3Njk5MCwiZXhwIjoyMDMxMjUyOTkwfQ.Dr8taQySTLl1aeSa-3w_gRh3wRvymhGeK-r3zJSFTvw"
...
@app.route('/carousel')
def carousel():
   return render_template('carousel.html', page_title='ABOUT')
